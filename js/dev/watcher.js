import { s as uniqArray } from "./functions.min.js";
...
var ScrollWatcher = class {
	...
	scrollWatcherCallback(entry, observer) {
		...
		if (targetElement.hasAttribute("data-fls-watcher-stat")) {
			const goingDown = entry.boundingClientRect.top < 0;
			if (!entry.isIntersecting && goingDown) targetElement.classList.add("--watcher-view");
		}
